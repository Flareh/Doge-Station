...
/datum/objective/download/proc/gen_amount_goal()
	...
	explanation_text = "Baixar [target_amount] niveis de segurança."
...
/datum/objective/heist/salvage/choose_target()
	...
	explanation_text = "Saquear ou trocar com a estação e escapar com [target_amount] [target]."
...
/datum/objective/wizchaos
	explanation_text = "Faça o máximo de estrago na estação que puder. Envie para os trouxas da Nanotrasen sem varinha uma mensagem!"
	completed = 1
